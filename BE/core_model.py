...
from Multi_modality.demo.utils import (retrieve_text,
                  _frame_from_video,
                  setup_internvideo2)
...
# import time
# t1 = time.time()
# top_probs, top_labels = get_top_k("A person is being interviewed. Behind this person, the wall is decorated with many shark teeth.")
# t2 = time.time()
