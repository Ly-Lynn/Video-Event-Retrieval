...
# Ensure the path to the parent directory (project) is added to sys.path
sys.path.insert(0, os.path.abspath('/content/drive/MyDrive/InternVideo/InternVideo2/multi_modality'))
