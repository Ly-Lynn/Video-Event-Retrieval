...
class TextVisualizer(Visualizer):
    ...
    # --------------------------- NEW MODIFY ----------------------
    def save_instances(self, predictions, image_id, outputdir):
        ...
        for i, bd in enumerate(bd_coordinates):
            # Extract x and y coordinates from bounding box, which are structured as [x1, y1, x2, y2]
            ...
            if x_max > x_min and y_max > y_min:
                ...
                if cropped_image.size != 0:
                    cv2.imwrite(f'{output_dir}/{scores[i]}.png', cropped_image)
